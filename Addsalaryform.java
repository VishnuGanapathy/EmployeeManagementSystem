 ...
 * @author vishn
 */
public class Addsalaryform extends javax.swing.JInternalFrame {
    Connection con=null;
    ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Employee Salary Add Form");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql="insert into saldetails values('"+empcode+"','"+fnm+"','"+lnm+"','"+gross+"','"+hra+"','"+da+"','"+conv+"','"+med+"','"+net+"')";
            int i=st.executeUpdate(sql);
            JOptionPane.showMessageDialog(null,i+"Record/s Inserted");clearall();
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, e);
        }
...
public void clearall(){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            String q="select empcode,firstname,lastname from empdetails where empcode='"+s+"'";
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/employee","root","root");
            pst=con.prepareStatement(q);
            rs=pst.executeQuery();
           while(rs.next()){
           ...
           String q1="select * from saldetails where empcode='"+s+"'";
           pst=con.prepareStatement(q1);
            rs=pst.executeQuery();
            if(rs.next()){
                JOptionPane.showMessageDialog(null,"there is already a record for this employee  in attendance cannot add again,IF U WANT TO UPDATE PLEASE UPDATE IN UPDATE FORM");
                jButton1.setEnabled(false);
                gross.setEnabled(false);
            }
            else{
                jButton1.setEnabled(true);
                gross.setEnabled(true);
            }
